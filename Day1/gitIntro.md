...
Git has a commit command, just like svn: mostly you will use it as follows: `git commit -m "comment"`
...
This is a Good Thing: you want to be able to keep up with your projects!
...
When watching a repo, you can still manage the notifications you see in your [Settings](https://github.com/settings/notifications). *Filtering* your email is also an effective strategy: you can label/redirect GitHub messinges by sender or repo name, but also by whether you are @mentioned (by your @username) in the messinge.
